...
class HomePage extends StatelessWidget {
  ...
  Widget _fondoApp() {
    ...
    final cajaRosa = Transform.rotate( // Permite rotar un child indicando el angulo. 
      angle: -pi / 5.0,
      child:  Container(
        height: 300.0,
        width: 300.0,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                  ...
                  Text('ASISTENTE MÉDICO', style: TextStyle(color: Colors.white, fontSize: 25.0, fontWeight: FontWeight.bold)), 
                  SizedBox(height: 30.0),
